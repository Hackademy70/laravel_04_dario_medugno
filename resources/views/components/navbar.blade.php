<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand text-light" href="{{ route('homepage') }}">Music<span class="custom-word">Room</span> </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link text-light" href="{{ route('contactus') }}">Contatti</a>
          </li>
        ...
        <form class="d-flex" role="search" method="GET" action="{{ route('strument.search') }}">
